...
* evalne:
This is the directory ot the evalne toolbox used for evaluation of the embeddings (<https://evalne.readthedocs.io/en/latest/index.html>) with the add of the cosine embedding operator.
* Generated_graphs:
...
* ResultsRWR:
The matrix of similarity generated by RWR-M(H) will be stored in this directory.
x
